...
def main(args):
    ...
    # DoG 
    # This is a monkey-patch to the diffusion.py file. It replaces the training_losses function with a new one that uses Domain Guidance loss.
    # This is done to avoid modifying the original diffusion.py file.
    patch_training_losses_with_DoG(diffusion, pretrained_model, args)
