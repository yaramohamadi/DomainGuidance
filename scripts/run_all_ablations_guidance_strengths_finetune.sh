...
#   "stanford-cars_processed" "cub-200-2011_processed" "artbench-10_processed" "food-101_processed" "caltech-101_processed"   "artbench-10_processed"
declare -a TASKS=(
  "food-101_processed"
)
...
PAIR_MAP["artbench-10_processed"]="1.6,12000,1.0,ablation_guidance_strengths 2.5,12000,1.0,ablation_guidance_strengths"
