...
custom_method_config = {
    "cub-200-2011_processed": {"ITER": "12000", "MG": "1"},
    "caltech-101_processed": {"ITER": "12000", "MG": "0.7"},
    "stanford-cars_processed": {"ITER": "12000", "MG": "1"},
    "food-101_processed": {"ITER": "12000", "MG": "1"},
    "artbench-10_processed": {"ITER": "12000", "MG": "0.8"},
    "ffhq256": {"ITER": "12000", "MG": "0.6"},
...
for dataset_folder, params in custom_method_config.items():
    ...
    mg_str = params["MG"]
    sample_folder = f"dogfinetune_LATE_START_ITER{iter_str}_MG{mg_str}_W_TRAIN_DOG1.5/samples/0024000"
    src_sample_path = os.path.join(dataset_path, "mega_ablation_latestart", sample_folder)
