...
# === Config ===
root_dir =  "/home/ymbahram/scratch/results/DoG/" # "/home/ymbahram/scratch/results/DoG/" # 
...
output_csv_path = os.path.join(
    output_dir, f"ablation_DiT_best_latestart_mg{metric_to_extract}_{model_type}.csv"
)
